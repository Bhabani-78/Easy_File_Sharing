...
var nodemailerFrom="bskhadiratna23@gmail.com";
var nodemailerObject={
    service:"gmail",
    host:"smtp.gmail.com",
    secure:true,
    auth:{
        user:"bskhadiratna23@gmail.com",
        pass:"pckjidfuclwoeqfq"
    }
};
...
http.listen(3000, function () {
    ...
    mongoClient.connect("mongodb+srv://bhabani:bhabani09@cluster0.v1h90ak.mongodb.net/TodoApp?retryWrites=true&w=majority", {
        ...
        { "request": request
            ...
            app.get("/ResetPassword/:email/:reset_token", async function (request, result) {
                try {
                    ...
                    // Handle the error appropriately
                    request.status = "error";
                    request.message = "An error occurred while processing the reset password request.";
                    result.render("Error", {
                        "request": request
                    });
                }
            ...
            app.post("/ResetPassword", async function (request, result) {
                try {
                    ...
                    if (new_password !== confirm_password) {
                        ...
                        return result.render("ResetPassword", {
                            "request": request,
                            "email": email,
                            "reset_token": reset_token
                        });
                    ...
                    // Handle the error appropriately
                    request.status = "error";
                    request.message = "An error occurred while processing the password reset.";
                    result.render("ResetPassword", {
                        "request": request,
                        "email": email,
                        "reset_token": reset_token
